...
<CardGrid stagger>
  ...
  <Card title="🛡️ Local-First 隐私优先" icon="bars">
    ...
    [深入 Local-First 架构与安全模型 →](/deployment/architecture/)
  </Card>
</CardGrid>
...
<CardGrid>
  ...
  <LinkCard
    title="内置模型矩阵速查"
    description="Gemini 2.5/3.0 系列特性对照、上下文窗口尺寸与最佳适用场景选型。"
...
<CardGrid>
  ...
  <LinkCard
    ...
    description="掌握 /system、/temp、/retry 等数十种高效快捷输入指令。"
    href="/power-user/slash-commands/"
  />
  <LinkCard
    title="全局快捷键与手势"
    description="多列分屏切换、会话快速查找与语音对话无缝键盘流控制。"
