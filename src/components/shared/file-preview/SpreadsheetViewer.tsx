...
export const SpreadsheetViewer: React.FC<SpreadsheetViewerProps> = ({ file }) => {
  ...
  const renderCellContent = (val: string | number | boolean | null | undefined) => {
  ...
  return (
    <div className="w-full h-full flex flex-col pt-20 sm:pt-22 pb-4 sm:pb-6 px-3 sm:px-6 select-text">
      <div className="w-full h-full flex flex-col rounded-2xl border border-[var(--theme-border-secondary)] bg-[var(--theme-bg-primary)] shadow-2xl overflow-hidden">
        ...
        <div className="flex-grow min-h-0 overflow-auto relative bg-[var(--theme-bg-primary)] custom-scrollbar">
          {rawRows.length === 0 ? (
            ...
            <table className="w-full border-collapse text-xs font-sans text-left">
              <thead className="sticky top-0 bg-[var(--theme-bg-secondary)] shadow-xs z-10">
